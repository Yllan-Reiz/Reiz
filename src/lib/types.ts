export type Update = { id: string; caption: string; progress_value: number; created_at: string; photo_url?: string; user_id?: string; objectives?: { visibility: string; unit?: string; target_value?: number } | null; users: any; };
